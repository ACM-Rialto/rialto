  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView(
        ...
        children: <Widget> [
          Category(imageLocation: 'assets/category/electronics.png', imageCaption: 'Electronics',),
        ...
        child: Container(
          ...
          child: ListTile(
            ...
            subtitle: Container(
              ...
              child: Text(imageCaption, style:TextStyle(color: Colors.black, fontSize:12.0),),
            ),
          ),
        ),
      ),
